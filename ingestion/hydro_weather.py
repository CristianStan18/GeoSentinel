"""
Ingestie hidro (infiltrații, nivel freatic) și meteo (precipitații).

SINTETIC: sinusoidal sezonier + zgomot + spike-uri în pre-eveniment.

REAL:
    - INHGA buletine zilnice: scrape de pe http://www.inhga.ro/
    - Open-Meteo API: https://open-meteo.com/ (gratuit, fără cheie)
      Exemplu: GET https://archive-api.open-meteo.com/v1/archive
               ?latitude=46.55&longitude=25.13
               &start_date=2024-12-01&end_date=2025-06-01
